...
available
link:http://andrewazor.es/frc3161/yggdrasil[here]. You can also download a
...
=== Download
See
link:http://andrewazor.es/frc3161/yggdrasil/latest[here] for the latest release
...
Copy all of the contents into your $USER/wpilib/user/userLibs directory, and
uncomment the line in your robot code project's build.properties file pointing
to this library directory.
...
link:http://andrewazor.es/frc3161/yggdrasil/latest/javadoc[here].
...
link:http://andrewazor.es/frc3161/yggdrasil/release/latest/javadoc[here
